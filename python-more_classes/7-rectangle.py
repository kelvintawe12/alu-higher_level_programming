...
for width and height, including property getters and setters, publ
to calculate the area and per, __str_ __repr__ methods
and a message printed when an instance of Rectangle is deleted.
It also includes public class attributes to keep track of the number of inst
"""
